...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>s.', '<cmd>Telescope oldfiles cwd_only=true<CR>', { desc = '[S]earch recent files in current pr[O]ject' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local parsers = { 'python', 'rust', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'kotlin' }
...
vim.keymap.set('n', '<leader>mu', ui.toggle_quick_menu)
